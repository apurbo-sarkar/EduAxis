            ...
            <form method="POST" action="{{ route('admin.users.teachers.store') }}">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="designation" value="{{ old('designation') }}" placeholder="e.g., Professor, Lecturer">
                        @error('designation')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="qualification" value="{{ old('qualification') }}" placeholder="e.g., PhD in Computer Science">
                        @error('qualification')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label>Salary</label>
                        <input type="number" name="salary" value="{{ old('salary') }}" step="0.01" min="0" placeholder="Monthly salary">
                        @error('salary')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
