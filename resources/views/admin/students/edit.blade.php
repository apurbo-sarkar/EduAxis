...
<body>
    <div class="container-custom">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2><i class="fas fa-user-edit text-danger"></i> Edit Student</h2>
        ...
        <form action="{{ route('admin.students.update', $student->student_id) }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="blood_group" class="form-control @error('blood_group') is-invalid @enderror" 
                           value="{{ old('blood_group', $student->blood_group) }}" placeholder="e.g., A+, O-">
                    @error('blood_group')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="student_class" class="form-control @error('student_class') is-invalid @enderror" 
                           value="{{ old('student_class', $student->student_class) }}" placeholder="e.g., Grade 1, Grade 5" required>
                    @error('student_class')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    <select name="academic_status" class="form-select @error('academic_status') is-invalid @enderror">
                        ...
                        <option value="Inactive" {{ old('academic_status', $student->academic_status) == 'Inactive' ? 'selected' : '' }}>Inactive</option>
            ...
            <div class="mb-3">
                ...
                <textarea name="status_remarks" class="form-control @error('status_remarks') is-invalid @enderror" 
                          rows="2">{{ old('status_remarks', $student->status_remarks) }}</textarea>
            ...
            <!-- Login Credentials -->
            <div class="section-title mt-4">
                <i class="fas fa-key"></i> Update Password (Optional)
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="parent1_name" class="form-control @error('parent1_name') is-invalid @enderror" 
                           value="{{ old('parent1_name', $student->parent1_name) }}" required>
                    @error('parent1_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="parent1_phone" class="form-control @error('parent1_phone') is-invalid @enderror" 
                           value="{{ old('parent1_phone', $student->parent1_phone) }}" required>
                    @error('parent1_phone')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="medical_notes" class="form-control @error('medical_notes') is-invalid @enderror" 
                          rows="3" placeholder="Allergies, medications, special needs, etc.">{{ old('medical_notes', $student->medical_notes) }}</textarea>
                @error('medical_notes')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
