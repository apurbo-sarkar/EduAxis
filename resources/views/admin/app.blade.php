...
<html lang="en">
    <head>
        ...
        <style>
            /* Base styles remain the same for structure */
            body {
            overflow-x: hidden;
            ...
            background: #0d6efd; /* Primary blue for active link */
            font-weight: bold;
            }
            .content {
            margin-left: 250px;
    ...
    <body>
        ...
        <header class="header d-flex justify-content-between align-items-center">
            ...
            <h5 class="m-0 fw-bold">Admin Portal</h5>
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <a href="{{ route('admin.enrollments') }}" 
                ...
                <i class="bi bi-list-task"></i> Enrollments
            </a>
