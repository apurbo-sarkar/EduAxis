...
class UserManagementController extends Controller
{
        ...
        try {
            ...
            if (!Schema::hasTable('students')) {
                return view('admin.users.index', [
                    ...
                    'activeStudents' => 0,
                    'activeTeachers' => 0,
                    'error' => 'Students table does not exist. Please run migrations.'
                ]);
            }
            ...
            if (!Schema::hasTable('teachers')) {
                return view('admin.users.index', [
                    ...
                    'activeStudents' => 0,
                    'activeTeachers' => 0,
                    'error' => 'Teachers table does not exist. Please run migrations.'
                ]);
            }
            ...
            $activeStudents = Schema::hasColumn('students', 'status') 
                ? Student::where('status', 'active')->count() 
                : $totalStudents;
            
            $activeTeachers = Schema::hasColumn('teachers', 'status') 
    ...
    */
    ...
    public function teachers(Request $request)
    {
        ...
        // Filter by status (only if column exists)
        if ($request->has('status') && $request->status != '' && Schema::hasColumn('teachers', 'status')) {
            $query->where('status', $request->status);
        }
